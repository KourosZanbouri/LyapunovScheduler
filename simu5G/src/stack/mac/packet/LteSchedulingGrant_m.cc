//
// Generated file, do not edit! Created by opp_msgtool 6.2 from stack/mac/packet/LteSchedulingGrant.msg.
//
...
LteSchedulingGrantDescriptor::LteSchedulingGrantDescriptor() : omnetpp::cClassDescriptor("simu5g::LteSchedulingGrant", "inet::FieldsChunk")
{
