//
// Generated file, do not edit! Created by opp_msgtool 6.2 from stack/mac/packet/LteHarqFeedback.msg.
//
...
LteHarqFeedbackDescriptor::LteHarqFeedbackDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::LteHarqFeedback)), "inet::FieldsChunk")
{
...
LteHarqFeedbackMirror::LteHarqFeedbackMirror() : ::simu5g::LteHarqFeedback()
{
    this->setD2dFeedback(true);

}

LteHarqFeedbackMirror::LteHarqFeedbackMirror(const LteHarqFeedbackMirror& other) : ::simu5g::LteHarqFeedback(other)
{
    copy(other);
}
...
{
    if (this == &other) return *this;
    ::simu5g::LteHarqFeedback::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::simu5g::LteHarqFeedback::parsimPack(b);
...
{
    ::simu5g::LteHarqFeedback::parsimUnpack(b);
    doParsimUnpacking(b,this->d2dSenderId);
    doParsimUnpacking(b,this->d2dReceiverId);
    doParsimUnpacking(b,this->pduLength);
}

const MacNodeId& LteHarqFeedbackMirror::getD2dSenderId() const
{
    return this->d2dSenderId;
}

void LteHarqFeedbackMirror::setD2dSenderId(const MacNodeId& d2dSenderId)
{
    handleChange();
    this->d2dSenderId = d2dSenderId;
}

const MacNodeId& LteHarqFeedbackMirror::getD2dReceiverId() const
{
    return this->d2dReceiverId;
}

void LteHarqFeedbackMirror::setD2dReceiverId(const MacNodeId& d2dReceiverId)
{
    handleChange();
...
LteHarqFeedbackMirrorDescriptor::LteHarqFeedbackMirrorDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::LteHarqFeedbackMirror)), "simu5g::LteHarqFeedback")
{
    propertyNames = nullptr;
}
...
const char *LteHarqFeedbackMirrorDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "simu5g::MacNodeId",    // FIELD_d2dSenderId
        "simu5g::MacNodeId",    // FIELD_d2dReceiverId
...
std::string LteHarqFeedbackMirrorDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    LteHarqFeedbackMirror *pp = omnetpp::fromAnyPtr<LteHarqFeedbackMirror>(object); (void)pp;
    switch (field) {
        case FIELD_d2dSenderId: return "";
        case FIELD_d2dReceiverId: return "";
...
omnetpp::cValue LteHarqFeedbackMirrorDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    LteHarqFeedbackMirror *pp = omnetpp::fromAnyPtr<LteHarqFeedbackMirror>(object); (void)pp;
    switch (field) {
        case FIELD_d2dSenderId: return omnetpp::toAnyPtr(&pp->getD2dSenderId()); break;
        case FIELD_d2dReceiverId: return omnetpp::toAnyPtr(&pp->getD2dReceiverId()); break;
