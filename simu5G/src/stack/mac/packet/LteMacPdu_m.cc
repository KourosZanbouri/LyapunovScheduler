//
// Generated file, do not edit! Created by opp_msgtool 6.2 from stack/mac/packet/LteMacPdu.msg.
//
...
LteMacPduDescriptor::LteMacPduDescriptor() : omnetpp::cClassDescriptor("simu5g::LteMacPdu", "inet::FieldsChunk")
{
...
MacControlElementDescriptor::MacControlElementDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::MacControlElement)), "")
{
    propertyNames = nullptr;
}
...
{
    doParsimPacking(b,(::simu5g::MacControlElement&)*this);
    doParsimPacking(b,this->size);
}

void MacBsr::parsimUnpack(omnetpp::cCommBuffer *b)
{
    doParsimUnpacking(b,(::simu5g::MacControlElement&)*this);
