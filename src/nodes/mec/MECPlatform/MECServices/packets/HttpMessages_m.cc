...
Register_Enum(simu5g::HttpMsgType, (simu5g::HttpMsgType::REQUEST, simu5g::HttpMsgType::RESPONSE, simu5g::HttpMsgType::UNKNOWN));

Register_Enum(simu5g::HttpRequestState, (simu5g::HttpRequestState::CORRECT, simu5g::HttpRequestState::BAD_REQ_LINE, simu5g::HttpRequestState::BAD_HEADER, simu5g::HttpRequestState::BAD_HTTP, simu5g::HttpRequestState::BAD_REQUEST, simu5g::HttpRequestState::DIFF_HOST, simu5g::HttpRequestState::UNDEFINED, simu5g::HttpRequestState::BAD_REQ_METHOD, simu5g::HttpRequestState::BAD_RES_LINE, simu5g::HttpRequestState::BAD_REQ_URI));

Register_Enum(simu5g::HttpResponseStatus, (simu5g::HttpResponseStatus::OK, simu5g::HttpResponseStatus::CREATED, simu5g::HttpResponseStatus::NO_CONTENT, simu5g::HttpResponseStatus::BAD_REQ, simu5g::HttpResponseStatus::UNAUTH, simu5g::HttpResponseStatus::FORBIDDEN, simu5g::HttpResponseStatus::NOT_FOUND, simu5g::HttpResponseStatus::NOT_ACC, simu5g::HttpResponseStatus::TOO_REQS, simu5g::HttpResponseStatus::BAD_METHOD, simu5g::HttpResponseStatus::HTTP_NOT_SUPPORTED, simu5g::HttpResponseStatus::SERV_UNAV));
...
HttpBaseMessageDescriptor::HttpBaseMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::HttpBaseMessage)), "inet::FieldsChunk")
{
...
const char *HttpBaseMessageDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "int",    // FIELD_sockId
        "simu5g::HttpRequestState",    // FIELD_state
        "bool",    // FIELD_isReceivingMsg
        "simu5g::HttpMsgType",    // FIELD_type
        "string",    // FIELD_body
...
const char *HttpBaseMessageDescriptor::getFieldProperty(int field, const char *propertyName) const
{
    ...
    switch (field) {
        case FIELD_state:
            if (!strcmp(propertyName, "enum")) return "simu5g::HttpRequestState";
            return nullptr;
        case FIELD_type:
            if (!strcmp(propertyName, "enum")) return "simu5g::HttpMsgType";
            return nullptr;
        default: return nullptr;
    }
}
...
std::string HttpBaseMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_state: return enum2string(pp->getState(), "simu5g::HttpRequestState");
        case FIELD_isReceivingMsg: return bool2string(pp->isReceivingMsg());
        case FIELD_type: return enum2string(pp->getType(), "simu5g::HttpMsgType");
...
HttpRequestMessage_m::HttpRequestMessage_m() : ::simu5g::HttpBaseMessage()
{
}

HttpRequestMessage_m::HttpRequestMessage_m(const HttpRequestMessage_m& other) : ::simu5g::HttpBaseMessage(other)
{
    copy(other);
}
...
{
    if (this == &other) return *this;
    ::simu5g::HttpBaseMessage::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::simu5g::HttpBaseMessage::parsimPack(b);
...
{
    ::simu5g::HttpBaseMessage::parsimUnpack(b);
...
HttpRequestMessage_mDescriptor::HttpRequestMessage_mDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::HttpRequestMessage_m)), "simu5g::HttpBaseMessage")
{
    propertyNames = nullptr;
}
...
HttpResponseMessage_m::HttpResponseMessage_m() : ::simu5g::HttpBaseMessage()
{
}

HttpResponseMessage_m::HttpResponseMessage_m(const HttpResponseMessage_m& other) : ::simu5g::HttpBaseMessage(other)
{
    copy(other);
}
...
HttpResponseMessage_mDescriptor::HttpResponseMessage_mDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::HttpResponseMessage_m)), "simu5g::HttpBaseMessage")
{
    propertyNames = nullptr;
}
